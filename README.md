...
- 📱 Crafting cross-platform mobile apps using **Flutter + React Native + TypeScript + Supabase + Firebase**  
- 💼 Freelanced with **MaroonFrog** on the **Etch Builder** framework — turning complex ideas into smooth web experiences  
...
### 🌐 Where to Find Me
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="https://linkedin.com/in/hesham-alkatout" target="_blank">
